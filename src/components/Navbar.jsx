        ...
        {usuario ? (
          <>
            ...
            <img 
              ...
              alt="Perfil" 
              className="w-10 h-10 rounded-full border-2 border-cyan-500 shadow-[0_0_10px_rgba(34,211,238,0.5)]" 
            />
            <button 
              onClick={onLogout}
              className="bg-zinc-900 p-3 rounded-xl hover:bg-red-900/20 text-zinc-400 hover:text-red-400 transition-all"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
            </button>
          </>
        ) : (
          <button className="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-2 rounded-xl font-bold text-white shadow-lg">
            INGRESAR
          </button>
        )}
        
        <div className="bg-zinc-900 px-4 py-2 rounded-xl border border-zinc-700 font-bold text-cyan-400">
          🛒 {carritoLength}
        </div>
      </div>
    </nav>
